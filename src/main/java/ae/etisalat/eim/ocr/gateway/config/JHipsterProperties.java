...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "OcrApiGateway2@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "OcrApiGateway2 API";

        private String description = "OcrApiGateway2 API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "OcrApiGateway2";
